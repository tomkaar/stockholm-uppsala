...
export const NotFound = () => (
  <div className="flex flex-col justify-center items-center mt-28 mb-20">
    ...
    <div className="mt-10 flex flex-row gap-2">
      ...
      <Link href={`/${stationStockholm}/${stationUppsala}/${dayjs().format("YYYY-MM-DD")}`} className="relative hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 text-sm text-slate-600 dark:text-white hover:text-white h-12 min-h-[48px] pl-8 pr-4 rounded-lg flex items-center pointer-events-auto">
        Dagens tidtabell
        <div className="ml-1">
